...
export default {
  ...
  created(){
    ...
    axios.get('http://work.08321.org/sell/goods.php?a=readOne&id='+this.ruleForm.id)
    .then((res)=>{

      console.log(res);
      this.ruleForm.name=res.data.data.goodsname;
      this.ruleForm.region=res.data.data.goodscategory;
      this.ruleForm.type=res.data.data.goodsfeature.split(',');
      this.ruleForm.imageUrl=res.data.data.imgUrl;
      this.ruleForm.resource=res.data.data.isPromotion;
      this.ruleForm.resource1=res.data.data.standard;
      this.ruleForm.num1=res.data.data.packprice;
      this.ruleForm.num2=res.data.data.price;
      this.ruleForm.desc=res.data.data.goodsdesc;
    })
  },
  methods: {
    submitForm() {
      this.$refs.ruleForm.validate(valid => {
        if (valid) {
          ...
          axios
            .post(
              "http://work.08321.org/sell/goods.php?a=edit",
